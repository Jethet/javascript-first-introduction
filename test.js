...
const user1 = {name: "Nick", id: 125125, borrowed: []};
const user2 = {name: "Sarah", id: 123123, borrowed: []};

const book1 = {title: "This title", author: "This author", isbn: "12345", category: "Classic"};
const book2 = {title: "Next title", author: "Next author", isbn: "56789", category: "Classic"};

const library = [];

user1.borrowed = book1;

const book3 = {title: "Third", author: "Third author", isbn: "333333", category: "Unknown"};
